...
Las columnas están ordenadas de manera inversa. El guion más reciente está primero.
...
#+caption: Estatua de Alan Turing en Bletchley Park, atrás su fotografía.
...
** \new{} ¿Qué es el filtro burbuja?                                    :ATTACH:
:PROPERTIES:
...
En la columna de hoy, hablaremos del doctor Manuel Sadosky. Pero antes, daremos un poco de contexto, la reforma universitaria de 1918, y cómo afectó después a las universidades. Sadosky junto con otros científicos trajeron y utilizaron la primer computadora a argentina, que cariñosamente la llamaron Clementina. ¿Quieren saber un poco de esta historia y quiénes fueron las primeras personas que programaron en Argentina? ¡Prepárense unos mates y escuchen este audio!
...
Emisión al aire: <2023-08-11 vie>
...
Emisión al aire: <2023-07-28 vie>
...
Emisión al aire: <2023-07-14 vie>
...
:END:
Emisión al aire: <2023-06-30 vie>
...
#+caption: Almanaque nautico (fuente Wikimedia Commons).
...
- Imágen de un Almanaque Náutico obtenido desde WikiMedia Commons. Autor: U.S. Naval observatory. Bajo dominio público.
  [[https://commons.wikimedia.org/wiki/File:Nautical_almanac_01.png][https://commons.wikimedia.org/wiki/File:Nautical_almanac_01.png]]
