...
2. Algunos ejemplos de plataformas digitales:
   ...
   - Voz over IP (videollamadas con/sin salas)
   - Aulas virtuales.
...
3. Hay una clasificación informal de los tipos de redes:

   - Centralizadas :: Poseen un servidor.
...
4. Otras categoría:
   ...
   1. libre vs. privativas.

   2. por su uso u orientación: Tinder, LinkedIn, researchgate.net, Flickr, Jamendo, Vimeo, Soundcloud, OpenClipArt, Thingiverse, YouTube, Sketchfab, Nappy, Wikimedia Commons.
