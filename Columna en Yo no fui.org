...
\radio{} Emisión al aire: No, aún no... ¡esta columna es un borrador!

1. ¿Cómo hago mi propio server?
   - Necesito una máquina...
2. Entonces... ¿Cómo puedo hacer mi nube?
   - No se tiene que apagar: UPS, ¿estabilizador?, varias locaciones...
   - No se tiene que caer: Internet... 
   - Seguridad: RAID
...
2. ¿Qué es la nube?
   ...
   1. Proveer un servicio.
      - Simplemente, solicitar y liberar el servicio por alguna interfaz o Web.
   2. No nos interesa gestionar la infraestructura por debajo, solo queremos el servicio.
      - Red, sistema operativo, almacenamiento (discos rígidos) \to{} ¡no nos queremos gestionarlo!
