...
1. Repaso:
   ...
   3. Sistemas de voto: Boleta Partidaria, Boleta Única de Papel, Voto Electrónico.
...
4. Recomendaciones al votar y al hacer escrutinio
   ...
   1. ¡Utilicemos todas las instancias de validación y chequeo que se nos brinden!
   ...
   6. Técnicos: Recordar solicitar permisos y notificar a las autoridades de mesa y del establecimiento de las tareas a realizar y las ya realizadas. Corroborar cada paso antes de hacerlo.
...
5. Escrutinio definitivo:
   - Debatamos: ¿se puede reproducir o recomponer de alguna manera lo que sucedió en el escrutinio provisorio? ¿qué necesitamos?
