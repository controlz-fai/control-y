...
4. ¿Se puede cobrar?
   ...
   Los cuatro principios (y contraejemplos):

   - Libertad 0 :: Ejecutar

     Trialware, crippleware, nag/beg/annoyware.

   - Libertad 1 :: Estudiar y hacer cambios

     Software que no se puede hacer ingeniería inversa.

     ¿Qué sucede con el software que generan los sitios Webs en PHP/.NET/Java/etc.?

   - Libertad 2 :: Distribuir copias

     Videojuegos distribuidos por en plataformas físicas o digitales.

   - Libertad 3 :: Distribuir copias con modificaciones

     Shareware
     
5. (Opcional) Open Source
...
7. ¿Y qué se hace con lo que se produce con un programa libre?
