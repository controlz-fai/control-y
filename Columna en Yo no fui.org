...
1. Creación e idea:
   ...
   3. Objetivos:
      ...
      - Sin regulación ni centralización.
...
4. Blockchain
   1. Descentralizado y distribuido.
   2. Actúa como un libro/registro contable.
   3. Secuencia de bloques de datos (los datos son las transacciones).
...
5. Una transacción
   ...
   1. Supongamos que mágicamente tengo 1B (¡ojalá!), y se lo quiero dar a Virgi (primer transacción).
   ...
   Opcional: ¿cómo se genera la primer transacción? O sea, en el ejemplo, ¿cómo obtuve 1B?
...
7. (Opcional) Métodos de consenso
   ...
   2. /Proof of Stake/ (PoS)
      1. El creador del bloque (forger) se designa aleatoriamente o bajo un criterio.
