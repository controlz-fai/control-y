...
2. En Hardware
   ...
   1. Un aparto resulta en desuso porque:
      ...
      2. No posee la misma funcionalidad,

      3. Deja de estar "de moda"

   2. Componentes de baja calidad o incorrectos.
...
3. En Software (y hardware \shrug{})

   1. El programa deja de funcionar porque:
   ...
   3. El mismo software se degrada:

      1. Su diseño es complejo adrede (p. ej.: un programa que se rompe a sí mismo, o tarda más debido a una mala elección del algoritmo o estructura de almacenamiento).

   4. Avances tecnológicos:

      1. Nuevos sistemas no poseen lo necesario para ejecutar programas viejos
...
5. El "derecho a reparar"
   ...
   Que legal y técnicamente podamos reparar los dispositivos que compramos. 
