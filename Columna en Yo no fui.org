...
En la entrega de hoy, comentaremos qué es el Software Libre. Te explicaremos que no solo es software que se puede conseguir gratis, sino que también es una idea y forma de hacer, disfrutar y compartir programas y recursos digitales. Esta forma de ver el mundo digital, en el que la colaboración lleva a construir software, que a su vez ayuda a compartir más contenido y soluciones. Esto, genera una comunidad que brinda compañía, conocimientos y experiencias a quienes lo necesitan. Entonces, el objetivo del Software Libre es: respetar al usuario y sus libertades.
...
"Spring" creado por Blender Foundation. Se encuentra bajo la licencia Cretive Commons Attribution 4.0 license.
