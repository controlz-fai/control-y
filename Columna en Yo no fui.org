...
#+caption: Cables marítimos para enterconectar redes.
...
2. ¿Qué es internet?
   1. Una red de redes... ¿en serio? bueno... internet (con "i" minúscula) es el concepto teórico...
      - Cuando en un edificio se quiere conectar con otro: dos redes, un cable, un par de máquinas que conectan a ambos extremos: ¡et violà! internet.
   2. Del Wi-fi de tu casa, del de tu vecina y vecino, al servidor de mensajería.
      1. Cómo es una red local: el Wi-fi de tu casa, cables de tus compus al router/modem ADS.

         Velocidad: ¿1 Mega, 10 Megas... un poco más?
         
      2. Cómo es una red de redes... del Wi-fi de tu casa, al proveedor de Internet.

         Mucha más velocidad: 10 Megas * cada cliente = ¿?

      3. Cómo es una red de redes, pero más troncal... del proveedor a otro proveedor mayorista.

         Muuuuucha más velocidad: 10 Megas * total clientes * proveedores = ¿?
