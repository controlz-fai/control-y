...
- Estamos frente a una compu con un LLM y queremos preguntarle algo:
  - ¿Qué puede hacer por nosotros?
  - ¿Cómo le pido algo?
  - No me responde como esperaba, ¿cómo lo mejoro?
- Supongamos que le escribo: /"quiero frases para el programa "Yo no fui""/
...
- ¡Las frases pueden ser muy largas o cortas! 
...
- Algunas frases son raras, con sentido medio extraño, o que no refieren mucho al programa.
...
- Otra cosa es que queremos que la frase hable de un desperfecto y que able de Meteoro. Si habla del equipo de la radio mucho mejor.
