...
* Columna 62: ¿Para qué podemos usar el LLM?
:PROPERTIES:
:ID:       cee7463a-d388-46f7-bed8-f6b76a67003d
:PUBDATE:  2026-06-18 jue 22:23
:END:
{{{tag(columna-62)}}}
1. ¿Para qué usar el LLM?
   - Ahora que comenté cómo hacer un prompt y cómo funciona \to{} ¿cómo la podemos usar?
   - Cabe aclarar que:
     - ¿Es posible instalar un LLM en mi compu? \to{} Si tenemos una compu con excelente placa de video, algunas LLM se pueden instalar... aunque para una persona no vale la pena.
     - ¿Entonces? \to{} Se utilizan servicios de Internet.
     - En resumen: hay LLM que se pueden instalar en tu institución y hay servicios en Internet para usar las LLM de terceros.
       - Esto quiere decir que mañana pueden aparecer nuevos servicios LLM...
2. Generar texto:
   1. Hacer resúmenes. Consultar algo que diga un texto.
   2. Búsqueda en grandes textos.
   3. Sugerencias de escritura: formal, cordial, amistosa, cambiando de intención, mejorando la escritura, ideas para comenzar a escribir.
   4. Determinar intenciones y posibles sentidos. "La persona que escribió el texto ¿demuestra felicidad?"
   5. Realizar traducciones. Determinar significados y formas de escritura.
   6. Explicaciones de conceptos. Búsquedas en Internet.
   7. Interpretar o explicar fórmulas (hojas de cálculo o matemáticas), códigos de programas, etc.
   8. Generar fórmulas para hojas de cálculo, códigos de programas, etc.
3. Procesar imágenes
   1. Transcribir textos (OCR) \to{} útil para copiar y pegar.
   2. Describir imágenes y sus situaciones \to{} muy útil para personas con problemas de visión.
   3. Buscar algo específico en la imágen. Identificación de objetos o personas y sus contornos.
   4. Describir un modelo o diagrama. Determinar si se puede intrepretar correctamente.
   5. Describir una fórmula matemática, una receta u otro contenido en una imágen.
   6. Traducir textos y carteles de una imágen.
4. Generar imágenes:
   1. Arreglos y cambios sencilos en las fotografías y dibujos.
   2. Hay LLM para hacer diagramas: sugerencias de modelado.
   3. Generación de sugerencias de ávatares, logos, etc.
   4. Conversión de 2D a 3D.
5. Procesar sonidos
   1. Determinar una canción o melodía.
   2. Determinar qué suena o quién canta (si es una persona pública, también se puede saber identificando la canción y preguntandole a otro chat su cantantes).
   3. Transcribir a texto (Speach To Text o STT).
   4. Resumir, describir el sonido o canción.
   5. Describir intención: "¿está enojado?"
6. Generar sonidos
   1. Generar canciones, melodías.
   2. Generar voces.
   3. Leer textos con distintas entonaciones o voces.      
7. ¿Qué tareas conviene usar una IA Generativa?
   1. Hay cosas que se pueden hacer con programas sencillos... ¿vale la pena usar tanto procesamiento?
      1. Sumamos números, sacamos porcentajes.
      2. Supongamos que queremos extraer de un texto desde que empieza "Listado de programas" hasta "esos es todo".
      3. Buscar una frase explícita en un documento: ¡usar ctrl+f!
   2. Hay cosas que es difícil de hacer en un programa sencillo:
      1. Determinar la intención de un texto
      2. Buscar un patrón o similitud en el texto: "¿se parece un texto de Shakespeare?"
      3. Resumir y generar un texto con otras palabras.
   3. Hay cosas que éticamente no deberíamos o que hay enormes riesgos:
      1. Si supíesemos programar, ¿permitiríamos tomar control de algún artefacto?
      2. ¿Permitiríamos que sustituya el rostro de una persona en una foto o que detecte las emociones de las personas en una institución pública en cualquier situación o contexto?
8. Pero... ¿debemos aceptar lo que nos dice?
   1. Siempre se debe estar chequeando la salida: /human in the loop/.
   2. No siempre aceptar que lo que nos entrega es correcto.
   3. Usarlo para sugerencias \to{} es ideal saber acerca de lo que se está preguntando.
      1. Es muy difícil de determinar si consutamos algo que no sabemos nada: "dame el código fuente en Python que simule peces en una pecera" \to{} ¿sabemos de programación? ¿me dará un código en paradigma imperativo, o orientada a objetos?
9. Top LLM:
   1. GPT 5 (OpenAI/ChatGPT), Gemini (Google), Llama (Meta), Grok (xAI), Claude (Anthropic), QWen (Anthropic), DeepSeek.
   2. Imágenes: Midjourney, Stable Diffusion, DALL-E (ChatGPT), Firefly
   3. Videos: DeeVid, Kling, Seedance, Gemini Omni, Sora, Grok Imagine
   4. Música: Suno, Lyria, Eleven Music, Google Flow Music, Stabel Audio,
   5. Archivos: GPTExcel, ChatPDF, 
   6. Escritura: NotebookLM, Quillbot
   7. Otras: hay servicios para logos, diseño 3D, asistentes personales (calendarios y agendas), organización de conceptos, generación de cuentos, búsqueda en Internet y en archivos, generación de presentaciones, edición de video, audios e imágenes, diseño de páginas Webs, procesamiento de correos, agentes, generadores de agentes

Para seguir buscando:

- https://github.com/steven2358/awesome-generative-ai 
- https://github.com/ai-collection/ai-collection
- https://llm-stats.com/ (no lo he chequeado completamente)
- https://aimultiple.com/generative-ai-applications#text-based-applications (no lo he chequeado completamente)
- https://a16z.com/100-gen-ai-apps-6/
- https://www.aixploria.com/

* Columna 61: ¿Cómo un LLM genera texto?
:PROPERTIES:
:ID:       e16e1ec2-5bb1-4d5c-b1db-ee4d504f534a
:PUBDATE:  2026-06-05 vie 11:37
:END:
{{{tag(columna-61)}}}

1. Primero: tokenización.
   1. Básicamente, por cada núcleo de palabra genera una secuencia de números.
   2. "El programa de Mete está todas las tardes."
   3. ¿Cómo le asigna números? \to{} por repetición en un corpus de entrada.
      1. "Mete" \to{} 5, 20, 77, ...
      2. "Yo no fui" \to{} 10, 21, 89, ...
      3. "Mete", "Frizán", "Virgi" y "Bomba", en el septimogésimo número dice "70" o "71" los cuatro.
      4. "Programa" en el quintigésimo segundo número debe decir 28, y "radio" puede ser 29.
      5. Incluso "tardes" y "afternoon" también generarían números cercanos. Los sinónimos seguramente tienen números cercanos.
      6. Cuanto más cerca, mayor relación de sintaxis o semántica.
2. Tranformaciones.
   1. Ahora supongamos un prompt. Le escribimos "¿Cuál es el mejor programa de radio?"
   2. Lo mismo, cada palabra se convierte en muchos números, incluso los símbolos si tienen relevancia.
   3. Fórmulas matemáticas buscan la relación entre palabras:
      1. "Programa" y "radio" determina que están relacionados porque ambos tienen el número 28 y 29.
      2. "Mejor" está en relación con "programa" porque 70  están en el septimogésimo número y otros números sumados y divididos me dán una cantidad determinada.
      3. También la sintaxis: una fórmula matemática encuentra que "mejor" debe ir antes que "programa" puesto que tiene un valor de 10 en el nonagésimo primer número, como todos los adjetivos, y "programa" tiene 57, como todos los sustantivos.
      4. Este análisis matemático complejo permite entender el contexto: cada vez que dice "programa", es de radio y no televisión.
   4. El resultado, son muchas secuencias de números con todos los detalles codificados ahí.
3. Generación de texto.
   1. El proceso es el siguiente:
      1. dado un prompt, lo tokeniza \to{} lo convierte en muchos números
      2. esos números los transforma en vectores generando muchos números (que son representaciones de palabras).
      3. y elije una de esas palabras con mayores probabilidades y esa es la que se queda
      4. luego vuelve a repetir con todo y las palabras generadas.
4. ¿De qué sirve saber esto?
   1. ¿Recuerdan que les dije que al hacer un prompt, una palabra puede cambiar mucho la respuesta?
   2. ¿Hay un proceso de razonamiento (/modus ponens/ / deducción, inducción, diagnóstico)?
   3. Si es probabilístico, ¿qué es lo que funciona mejor? ¿qué opinan si utilizo algo que no sea un patrón? ¿podemos concluir que los LLM piensan, sienten o se ven influenciados por los sentimientos?
   4. ¿Qué sucede si uno imagina un paisaje o una canción y trata de explicarla? ¿podrá repetir este proceso? ¿cómo sería imaginar el paisaje o la canción para el LLM? ¿o debemos dárle la canción para que explique cómo le influencia?
   5. ¿Las "influencia" o las explicaciones estarían basadas en una experiencia personal o patrones encontrados en Internet?
   6. ¿Se puede asegurar que un LLM siempre responda información verídica? Como los LLM se suelen entrenar con información de Internet: ¿qué pasa si en Internet se repite la misma información falsa (por ejemplo: se repite que 2 + 2 = 5, o sea, aún si nuestra deducción indicaría que esa información está mal)?
   7. ¿Qué pasa con la información que no está presente en Internet, pero puede deducirse? Por ejemplo, la hora actual en Japón puede no estar en Internet, pero se sabe que es de 12 horas más: ¿podría el LLM contestar con la hora correcta?

      Los LLM pueden tener procesos extras para estos casos. ¿Cuáles programas extras y cuáles casos extras se resuelven que no sean con el LLM?
   
Bibliografía: "Prompt Engineering for Generative AI", James Phoenix y Mike Taylor. O'Reilly. 2024.

* Columna 60: Prompting
:PROPERTIES:
:ID:       58a0e00d-c74c-4dfd-af2d-68bfa69482dc
:PUBDATE:  2026-05-08 vie 11:07
:END:
{{{tag(columna-60)}}}

1. Estamos frente a una compu con un LLM y queremos preguntarle algo:
   - ¿Qué puede hacer por nosotros?
   - ¿Cómo le pido algo?
   - No me responde como esperaba, ¿cómo lo mejoro?
2. Supongamos que le escribo: /"quiero frases para el programa "Yo no fui""/
   - Recibimos una lista de frases, posiblemente con toda una explicación y la simpatía del chatbot, y probablemente la lista de frases refieran a cualquier cosa.
   - Pero nosotros queremos que un listado de frases pegadizas, que digan "Meteoro" y que sea para nuestro programa de radio.
   - ¿Y si le decimos para qué es la frase?
     /"Quiero frases que hable del programa de radio "Yo no fui" y es para reproducir en durante la tanda publicitaria. Las frases deben hablar de "Meteoro", el conductor del programa."/
   - Pero en ninguna aparece Virgi ni Bomba: nunca le informamos al bot de ellos, y el bot no siempre busca información en Internet.
     /"Quiero frases que hable del programa de radio "Yo no fui" y es para reproducir en durante la tanda publicitaria. Las frases deben hablar de "Meteoro", el conductor del programa. También pueden hablar de Virginia, Bomba o Pablo que siempre participan del programa."/
   - ¿Qué pasó con mi prompt inicial? Fue *vago e incompleto*.
   - Los LLM sostienen un contexto: dura un tiempo (¿7 días, 30 días...?). Si una pregunta muy vaga funciona, puede deberse a que antes le diste información.

   - Los LLM no adivinan, no tienen corazonadas ni pueden deducir lo que sabés e interpretás.

     Si no se le brinda contexto e información, no pueden procesarla ni entregarla: se debe dar la información completa, por ejemplo: ""Yo no fui" [con comillas y todo para indicar que es una cosa] es un programa de radio".

3. ¡Las frases pueden ser muy largas o cortas! 
   - Le agregamos: "Solo deseo una frase de una o dos oraciones. No quiero explicaciones ni saludos."
   - El bot no sabe cómo queremos la respuesta y si tiene que seguir algún *formato*.

4. Algunas frases son raras, con sentido medio extraño, o que no refieren mucho al programa.
   - Si le damos ejemplo, sirve más, ¡hasta podemos ahorrarnos explicaciones!
   - Le agregamos: "Por ejemplo: "Meteoro está arreglando el micrófono que se rompió, pero "Yo no fui"".
   - Los LLM son excelentes con patrones. Por ello, darles *ejemplos* sirve muchísimo.
    
5. Dividir la labor:
   - Cuanto más largo y enroscado el prompt \to{} respuestas menos determinísticas, con más errores (elaboraciones erróneas) y anomalías.
   - Lo mejor es dividir un prompt largo en partes pequeñas.

6. Otra cosa es que queremos que la frase hable de un desperfecto y que able de Meteoro. Si habla del equipo de la radio mucho mejor.
   - Le agregamos: "Se prefiere"
    
7. Principios para un buen prompt:
   1. Dar dirección
   2. Especificar el formato
   3. Proveer ejemplos
   4. Evaluar calidad
   5. Dividir la labor

   Estos principios no son solo para prompting. También se utilizan en comunicación. 

Preguntas:

- ¿Usabas los LLM así? ¿te pasó que le preguntaste algo y te respondió con algo que no era lo que buscabas?
- Ahora que sabés estos principios, ¿cambiaría tu forma de preguntarle al ChatGPT? ¿cómo cambiaría? ¿qué impacto tiene cambiar la forma de preguntar las cosas?
- Con los principios, ¿considerás que te puede ayudar para cualquier tarea? ¿para qué tareas puede no ayudarte?
  - ¿Puede responder cualquier pregunta? ¿cuáles sí y cuáles no? ¿por qué?

* Columna 59: Personas: ¡Evaluación! 😱
:PROPERTIES:
:ID:       370c43d7-e324-41cd-8f76-715d3f4587c5
:PUBDATE:  2026-05-08 vie 11:07
:END:
{{{tag(columna-59)}}}

Hoy, ¡examen! ¡saquen una hoja!

Ejercicios: respondan las siguientes preguntas:

- ¿De quiénes hablamos?
  - Linus Torvards, Bill Gates, Richard Stallamn, Aaron Swartz, Tim Berners-Lee, Marissa Mayer, Anat Ashkenazi Ruth Porat, Carol Ann Bartz, Sam Altman, Greg Brockman, Sarah Friar, Paul Graham.
- ¿Por qué hablamos de estas personas? ¿Qué hicieron de importante?
  - OpenAI: Sam Altman, Greg Brocman, Sarah Friar
  - Yahoo o Google: Marissa Mayer, Anat Ashkenazi, Ruth Porat, Carol Ann Bartz
  - ¿Qué relación tienen con otras empresas o entidades?
    - ¿Se acuerdan todas las entidades y empresas que mencioné?

      AutoDesk y AutoCad, Nextdoor, AT&T Walmart, Starbucks, Helion Energy Inc., Y Combinator o Hacker News, Loopt, Bill & Mellinda Foundation, Wikipedia y otras Wikis, Infogami, Reddit, Public.Resource.Org, Open Library (archive.org).

    - ¿Qué diferencia encuentran en las distintas entidades de cada persona que hablamos?
  
- ¿Qué diferencias encuentran entre las distintas personas?
  - ¿Y la educación de las mujeres con respecto a la de los hombres en general?
  - ¿Qué pensamientos y posturas tienen? ¿con cuáles Ustedes se identifican más?
- ¿Qué relevancia tienen estas personas en la actualidad?
  ¿Qué decisiones pueden tomar en la tecnología y la investigación?
  ¿Por qué?
- ¿Cómo afectó la universidad en sus vidas? ¿Les acercó el conocimiento que requerían? ¿Fue un nexo entre las personas, la academia y la investigación?
  - ¿Qué impacto tiene la proximidad de la universidad en sus vidas? ¿cuál les parece que fueron las causas que hayan decidido ir a esas universidades y no a otras? 
- ¿Cómo afectó el contacto con la computación a temprana edad?
  - ¿Cómo ven el contacto que tuvieron estas personas con respecto al que hoy en día se dá en niñas y niños?
- ¿Cómo era el acercamiento a la informática que daba la escuela en aquellas épocas? ¿y en la actualidad?

* Columna 58: Personas: Linus Torvards
:PROPERTIES:
:ID:       9c2ff39d-de9e-46ae-9432-63d3de00f58d
:PUBDATE:  2026-05-08 vie 11:07
:END:
{{{tag(columna-58)}}}

1. Linus Benedict Torvards, nación en 1969 en Finlandia.
2. A los *11 años* comenzo a programar en BASIC con una computadora VIC-20 (anterior a la Commodore 64). Más tarde aprendió a introducír el código máquina (no assembler).
3. Fue a la Universidad de Helsinki en el 88', aunque sus estudios fueron interrumpido al primer año por hacer servicio militar obligatorio, luego continuó hasta recibirse de *Master en Ciencias de la Computación* con su tesis en 1997 "[[https://www.cs.helsinki.fi/u/kutvonen/index_files/linus.pdf][Linux: a Portable Operating System]]".
4. En la universidad entró en contacto con una computador MicroVAX que tenía instalado el software ULTRIX, y con el libro /Operative Systems: Design and Implementation/ de Andrew Tanenbaum (ese mismo libro es el que usamos en la carrera de la FaI UNCo, pero varias ediciones actualizadas). En el libro describe cómo funciona un sistema operativo llamado MINIX.

   - ULTRIX: un sistema privativo y cerrado por la empresa DEC, basado en UNIX.
   - MINIX: (mini-unix) un sistema open source (abandonado a la fecha), basado en UNIX. Inicialmente fue pensado para enseñar, pero después sus objetivos migraron a un núcleo que sea confiable y utilizable en hardware con pocos recursos.

   Si notaron los nombres de los sistemas...
5. En 1991, recibe una copia de MINIX y compra una computadora IBM PC y comienza a trabajar con su núcleo Linux. Publicó varios prototipos desde los servidores de su universidad inicialmente.

6. Debido a la charla que Richard Stallman realizó en la universidad y presiones de colaboradores, Linus libera el código con Licencia GNU GPLv2, haciendo de Linux un Software Libre. 
   
7. En 1994 publica Linux 1.0. Entre el 97' y 2003 trabaja en Open Source Development Labs, que luego se une con otra empresa y pasa a crearse la Linux Foundation, que es la entidad que actualmente sostiene el Linux.

8. Recibió muchos reconocimientos, de parte de la IEEE (IEEE Computer Pioneer Award), Internet Hall of Fame, Lovelace Medal, EFF Pioner Award.

   Linux se utiliza en: routers, servidores, celulares Android, muchos embebidos y electrodomésticos "smart" (heladeras, lavarropas, etc.).

9. Personal: se considera agnóstico y le parece irónico que en muchos países europeos haya como una relación legal entre el estado y el estado religioso (citando la fuente: "/it's kind of ironic that in many European countries, there is actually a kind of legal binding between the state and the state religion./" de [[https://www.linuxjournal.com/article/3655][Linux Journal "/Interview: Linus Torvards/", 1999]]).

   Si bien puede votar en Estados Unidos no desea afiliarse a ningún partido.

   Es reconocido por ser una persona difícil de tratar en el ámbito laboral. [[https://arstechnica.com/information-technology/2013/07/linus-torvalds-defends-his-right-to-shame-linux-kernel-developers/][Se conocen casos que se dirije un tanto subido de tono a sus colaboradores.]]

Preguntas:

- De nuevo, ¿qué les parece el acercamiento temprano a las computadoras?
  En este caso a la programación.
  - ¿Qué diferencias encuentran en el acercamiento actual con respecto al que tuvo Linus hacia las computadoras?

- Linux está hecho por muchas personas, ¿pudieron ver la importancia de trabajar en grupo y la colaboración?

- Las primeras versiones de Linux se publicaron en el servidor de la Universidad de Helsinki.

  ¡La tesis de Linus fue en el 97' y su proyecto inició en el 91'!
  
  ¿Observaron el efecto de la universidad como potenciadora de un proyecto tan grande?

  Linus conoció MINIX y el libro de Tanenbaum en la universidad:

  ¿Y la universidad como ente que aproxima las personas al conocimiento y desarrollo actual?
  

* Columna 57: Personas: Bill Gates
:PROPERTIES:
:ID:       4181f7ae-e985-48d7-b924-6d1a8a9de83c
:PUBDATE:  2026-03-06 vie 10:59
:END:
{{{tag(columna-57)}}}

1. Nació en 1955 (70 años).
2. En la secundaria donde iba, adquirieron una computadora donde Bill Gates tuvo sus primeros acercamientos.
   1. Aprendió a programarla en BASIC.
   2. Su interés en las computadoras y programación continúo con sus amigos.
   3. Armó un club de programadores para ganar dinero.
3. Luego, Gates fue penalizado de un centro de computo compartido por explotar errores del sistema para obtener más tiempo de uso.
   1. Eran computadoras de uso compartido: llevabas tu programa, y se ejecutaba en una enorme máquina.
   2. Al terminar su penalización, le ofrecieron trabajar para el centro de cómputo a cambio de tiempo de uso de la computadora.
   3. Gates aprovechó para aprender del sistema y los lenguajes que usaba.
4. Se graduó del secundario con honores y fue a Hardvard.
5. Bill Gates estudió dos años en Harvard, *luego dejó para comenzar su compañía* "Micro-Soft".
   1. Su compañero (futuro CEO de Microsoft) Steve Ballmer sí se graduó de Harvard.
6. Microsoft:
   1. 1975: Microsoft trabajó con MITS desarrollando Altair BASIC (del cual se filtraron copias de pre-venta).
   2. 1980: IBM le solicita un intérprete de BASIC y un sistema operativo. Gates le ofrece adaptar 86-DOS desarrollado por la empresa SCP. Contrata a uno de los desarrolladores de SCP para continuar adaptándolo. Este nuevo software se llamó *PC DOS*.
      1. Gates se enfoca en el prestigio y no en ganar dinero.
      2. Observa que las máquinas IBM PC podrían ser clonadas, por lo que *no transfiere el copyright*.
      3. MS-DOS es la versión de PC DOS vendida a otros clientes.
      4. 1985: Realizan Windows 1.0 (compitiendo con el de Apple). En paralelo, en 1986, crean OS/2 junto a IBM.
      5. El resto de los sistemas Windows crece a partir de MS-DOS (hasta el Windows XP)
7. Microsoft y Bill Gates *han realizado donaciones* a distintas fundaciones ( Harvard, Carnegie Mellon, etc. una de las fundaciones es la propia Bill & Melinda Foundation).
8. Bill Gates dejó de ser chairman en febrero del 2014. 
9. ¿Es programador? \to{} Sin duda que fue programador de BASIC, Fortran, LISP y algún otro lenguaje. Era desarrollador mientras trabajaba en Microsoft.

   Pero sin duda es un hábil negociante, posiblemente mejor que programador.
10. En el COVID-19 sugirió a las compañías evitar liberar las patentes de las vacunas. Es crítico de las Criptomonedas. Ha comentado rechazos acerca de regulaciones en la industria del software. No estuvo muy a favor del ban a Trump en Twitter. Considera el cambio climático algo crítico para la sociedad, aunque la comunidad activistas es escéptica con su solucionismo tecnológico (y no incluir las soluciones hacia lo social-cultural).

Preguntas:

- Bill Gates entró en contacto jóven con las computadoras y la programación. ¿Qué les parece el acercamiento de las niñas y niños a la computación? ¿Sucede de la misma manera que como sucedió con Bill Gates? ¿Es importante que se acerquen para explorar y conocer las computadoras y la programación? ¿Podrá ser esto una razón por la que hay menos mujeres ingresantes a carreras STEM?

* Columna 56: Personas: Tim Berners-Lee
:PROPERTIES:
:ID:       debce225-9ec5-4960-9bab-b7e7218d95fd
:PUBDATE:  2026-02-06 vie 11:08
:END:
{{{tag(columna-56)}}}

#+caption: Sir Tim Berners-Lee con Jude Kelly.
[[https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/Sir_Tim_Berners-Lee_and_Jude_Kelly.jpg/960px-Sir_Tim_Berners-Lee_and_Jude_Kelly.jpg]]

1. Nació en 1955.
2. Familia
   1. Sus padres trabajaron en la Ferranti Mark 1.
      Clementina (1961-1971), nuestra primer computadora, es una Ferranti Mercury, sucesora de esta.
   2. Su hermano Mike Berners-Lee es un investigador y escritor acerca de la huella de carbono. Escribió varios libros "No hay planeta B", "un clima de verdad", etc.
      1. Participó en el libro "El libro del clima" editado por Greta Thunberg. ¿Tienen ese libro?
3. Estudios
   1. Estudió Queen's College Oxford
   2. Aprendió electrónica con modelado de trenes. En el 76' comenzo sus estudios en física.
   3. Es profesor emérito del MIT y investigador en la universidad de Oxford.
4. Investigación y trabajo / Inicio de la Web
   1. Trabajó en para el CERN (/Counseil Européen pour la Recherche Nucléaire/, conocido hoy como Organización Europea para la Investigación Nuclear, donde está el acelerador de partículas) en junio de 1980.
      1. Propuso un proyecto de hipertexto, para comunicar los artículos e informes entre investigadores.
      2. Hipertexto: básicamente es texto con enlaces que se pueda hacer clic.
      3. Presentó un prototipo: ENQUIRE.
   2. En 1989, el nodo más grande de Internet de Europa estaba en el CERN, esto mejoró la posibilidad de unir la idea con Internet. La propuesta fue aceptada por su jefe y Tim desarrolló:
      - el primer explorador Web: WorldWideWeb era un editor y lector.
      - el primer servidor Web: CERN httpd.
      - el primer sitio Web el 20 de diciembre de 1990 ([[https://www.w3.org/blog/2016/25-years-ago-the-world-changed-forever/][ver blog]], donde aún se puede visitar y ver capturas del primer explorador Web).
5. En 1994 funda la W3C (World Wide Web Consortium) en el MIT. Publicó su idea, sin es patentes ni costos, y similarmente es una política que sigue la W3C: los estándares son libres y sin costos. Esto motiva a la expansión de la WWW.
...
6. En el 2001 trabaja en la Web Semántica, una "evolución" de la Web actual (y no es la Web 3.0).
7. Se pronuncia a favor de la neutralidad de la red.
8. Sin embargo, luego de un tiempo neutral, se pronuncia en contra del movimiento anti-/Digital Right Management/ promovido por la /Electronic Frontier Foundation/, la campaña /Defective by Design/ y la /Free Software Foundation/.
9. Reconocimientos.
   1. En el 2004 fue nombrado Knight por la Reina Elizabeth II.
   2. En el 2007 fue incluido en la Órden de Mérito. Órden que solo se permite a 24 personas con vida.
   3. En el 2016 recibió el ACM Turings Award por al invención de la WWW.

** Más información
:PROPERTIES:
:ID:       51d3a7fa-49b7-47ba-a685-c8739721808f
:END:
...
** Recursos
:PROPERTIES:
:ID:       06fb9259-fd4a-4bf9-bd3d-9fd54929037c
:END:
...
[[https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/Sir_Tim_Berners-Lee_and_Jude_Kelly.jpg/960px-Sir_Tim_Berners-Lee_and_Jude_Kelly.jpg]]
Obtenida desde Wikimedia commons bajo la licencia Creative Commons Atribución 2.0 Genérica.  [[https://commons.wikimedia.org/wiki/File:Sir_Tim_Berners-Lee_and_Jude_Kelly.jpg][Ver en Wikimedia Commons.]]

#+html: </div>

* Columna 55: Personas: Aaron Swartz
:PROPERTIES:
:ID:       402625d9-1798-4c42-b705-d3b8dbf4b42a
:PUBDATE:  2026-01-29 jue 18:01
:END:
{{{tag(columna-55)}}}

#+caption: Aaron Swartz en Occupy Wall Street, 18 de enero del 2012
[[https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/AaronSwartzPIPA.jpg/960px-AaronSwartzPIPA.jpg]]
...
- El software de Infogami fue utilizado para [[https://openlibrary.org/][Open Library]] (de archive.org). Incluso, Aaron Swartz ayudó a coordinar un equipo para descargésta empresa imponía.

  https://openlibrary.org/about/team
...
- Se opuso al /Stop Online Piracy Act/ (SOPA), un proyecto de ley que brinda al capacidades al estado para comabtir el tráfico de contenido con derechos de autor. Las críticas en contra de SOPA fueron que generaba incertidumbre en cuanto a su formulación y alcance. Por ejemplo, artistas que realizan covers o bibliotecas podrían ser acusadas, incluso todo un sitio Web podría bloquearse por la justicia solo por una única violación (un video o una obra).
  ...
  [[https://web.archive.org/web/20111116234719/http://www.librarycopyrightalliance.org/bm~doc/lca-sopa-8nov11.pdf][Carta de la Library Copyright Alliance acerca de SOPA.]]

  https://www.eff.org/issues/coica-internet-censorship-and-copyright-bill
  
- En el 2011 fue arrestado por descargar una gran cantidad de artículos científicos desde el [[https://www.jstor.org/][JSTOR]] (una biblioteca digital) usando una computadora conectada a la red del MIT. JSTOR contenía artículos que no eran de acceso público o abierto. Este incidente pudo haber sido el causante de apurar la apertura de una gran cantidad de artículos.
...
- Hay un documental que habla de él: "/The Internet's own boy: the story of Aaron Swartz/".
  ...
  [[https://www.imdb.com/es/title/tt3268458/?ref_=ext_shr_lnk][Enlace a la descripción del documental en IMDB]]

  El 8 de noviembre de cada año (desde el 2013) se celebra en algunas partes del mundo el día de Aaron Swartz.

  https://www.aaronswartzday.org/about/
...
** Recursos
:PROPERTIES:
:ID:       cdb7d848-1d16-4a56-b851-58faacb29246
:END:

#+attr_html: :width 25% :align left :style display: inline-block
[[https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/AaronSwartzPIPA.jpg/960px-AaronSwartzPIPA.jpg]]
bajo la licencia Atribución-CompartirIgual 2.0 Genérica de Creative Commons.
[[https://commons.wikimedia.org/wiki/File:AaronSwartzPIPA.jpg][Ver en Wikimedia Commons.]]

* Columna 52: Personas: OpenAI
:PROPERTIES:
:ID:       3bc6a72a-e5b4-4cfc-93a8-ab068be884cf
:PUBDATE:  2026-01-09 vie 11:31
:END:
Solo una columna más relajada porque estamos en vacaciones...
* Columna 51: OpenID :ATTACH:
:PROPERTIES:
:ID:       5837576c-5882-46d3-99e7-0b0fab01726a
:PUBDATE:  2025-12-12 vie 10:12
:END:
{{{tag(columna-51)}}}

#+caption: Captura de pantalla del inicio de Sesión de Spotify.com. Se observa los botones para iniciar sesión utilizando Google, Facebook u otros servicios.
[[file:data/58/37576c-5882-46d3-99e7-0b0fab01726a/Login-Spotify.png]]

1. Hemos visto varias formas de autenticarse:
   1. Los factores de autenticación.
   2. El segundo factor y One-Time Passwords (OTP).
   3. Recordar: *¡nunca compartir contraseñas ni tokens!*
2. Hay una forma de autenticarse más que es utilizando OpenID.
   1. Normalmente, no lo vemos como "OpenID", sino como "Conectarse usando Google", "Conectarse con Facebook" o similar.
3. ¿Cómo funciona?
   1. Cuando queremos iniciar sesión en algún servicio, supongamos spotify.com, vemos que dice "Iniciar sesión" y nos pide usuario y contraseña, y más abajo hay botones: "Continuar con Google", "Iniciar sesión con Facebook", etc.
   2. Hacemos clic en "Continuar con Google".
   3. Si la sesión de Google no está abierta, nos pide que la iniciemos con usuario y contraseña de Google. Si la sesión está abierta continúa.
   4. Por única vez, Google nos pide que autoricemos a Spotify, y nos indica qué datos Spotify va a utilizar de nuestra cuenta de Google. Si autorizamos, no nos pregunta más en los próximos inicio de sesión de Spotify con Google.
   5. Luego, nos muestra Spotify con la sesión nuestra abierta.

4. Pero internamente, ¿cómo funciona?


#+caption: Funcionamiento interno de OpenID.
[[https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/OpenIDvs.Pseudo-AuthenticationusingOAuth.svg/960px-OpenIDvs.Pseudo-AuthenticationusingOAuth.svg.png]]
      
   1. Internamente, usa al exprolador Web como intermediario para intercambiar credenciales y tokens entre un tercero (Google) y el servicio (Spotify).

   2. Spotify solicita al explorador que a le pida a Google credenciales (tokens).

   3. El explorador envía los datos de Spotify y de sesión de Google a Google. Google confirma la sesión propia y chequea si Spotify está autorizado.

      1. Si no está, responde con una página para que el usuario autorice o rechace.

      2. Si está autorizado, responde con un token largo de autorización para Spotify.

   4. El explorador recibe el token de autorización desde Google y se lo envía a Spotify para que inicie la sesión.

   5. Spotify recibe, chequea el token si es correcto e inicia sesión.

5. ¡Está buenísimo!

   1. ¡Solo nos tenemos que acordar de un usuario y clave! (El de Google)

   2. Hay cada vez más servicios que permiten iniciar sesión con OpenID.

6. Pero...

   1. ¡Ojalá nunca entren a tu cuenta de Google o GMail! Perdés el acceso a Google y perdés el acceso a los otros servicios (y a no pensar en resetear la clave).

   2. Si el explorador Web tiene la sesión de Google iniciada y alguien usa tu compu: ¡acceso total a todos los otros servicios!

      ¿Cuántas veces iniciaste sesión en tu trabajo u otro lugar? ¿y cuántas veces se te olvida cerrarla?

   3. Justamente, no todos los servicios que usamos soportan iniciar sesión con OpenID (menos los home-bankings).

   4. En algunos sitios, hay que crear una cuenta con usuario y contraseña y después se configura el OpenID.

7. Hasta ahora vimos autenticación, no vimos autorización.

   1. La identificación es preguntar quién es la persona: es el nombre de usuario al iniciar sesión.

   2. La autenticación es para determinar si quien dice ser es real: para eso se usa uno o más factores de autenticación: algo que sabés, algo que eres, algo que tenés, algo que hacés, dónde estás.

      Puede ser la contarseña al iniciar sesión, la tarjeta para el cajero, la huella dactilar para el celular, etc.

   3. La autorización es para determinar qué puede hacer dentro de un sistema.

      Los pasos anteriores son necesarios para la autorización.

** Recursos
:PROPERTIES:
:ID:       90f1eadf-41f0-4614-a5ab-e812be56c307
:END:

- https://www.google.com/intl/es/account/about/sign-in-with-google/
  - [[https://developers.google.com/identity][Documentación de Google para desarrolladores]]
...
#+attr_html: :width 25% :align left :style display: inline-block
[[https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/OpenIDvs.Pseudo-AuthenticationusingOAuth.svg/960px-OpenIDvs.Pseudo-AuthenticationusingOAuth.svg.png]]
"OpenIDvs.Pseudo-AuthenticationusingOAuth.svg" por Saqibali, bajo la licencia Dedicación de Dominio Público CC0 1.0 Dedicación a Dominio Público Universal de Creative Commons. Obtenido desde Wikimedia Commons. [[https://commons.wikimedia.org/wiki/File:OpenIDvs.Pseudo-AuthenticationusingOAuth.svg][Ver imágen en Wikimedia.]]
* Columna 50: Segundo factor - One-time Passwords
:PROPERTIES:
:ID:       88e6b7c3-acec-4498-90e2-0a7fbd213b1a
:PUBDATE:  2025-11-27 jue 20:54
:END:
{{{tag(columna-50)}}}

# Gestores de contraseñas

# Baúles, gestores de contraseñas, almacenes de contraseñas.

# 1. Generan contraseñas.
# 2. Mantienen un historial de cambios.
# 3. Cifran el almacén.
# 4.

1. Los factores de autenticación son: algo que sabés, algo que eres, algo que tenés, algo que hacés, dónde estás. El segundo factor (2FA) implica uno más aparte de algo que sabés (la contraseña).
2. Normalmente se utilizan /one-time passwords/ (OTP) para implementar un segundo factor.
   
   Los OTP son contraseñas de un solo uso. 
   
   1. Usualmente son PIN o "token" (numéricos) de 6 o más dígitos.
   2. Cambian al pasar el tiempo:
      1. Depende de la hora actual.
      2. Se vencen a 1, 5 o más minutos.
   3. Usualmente el PIN lo genera o se debe leer desde un dispositivo extra: un celular, un token hardware, una computadora, etc.
3. ¿Cómo se usa?
   ...
   1. Le indicamos al sitio (p. ej. nuestro correo electrónico) que queremos utilizar segundo factor (2FA).
   2. Nos brinda una secuencia de letras y números que debemos pegar en la aplicación del celular.
   3. En el celular, abrimos la aplicación, registramos la secuencia de letras y números bajo un nombre (p. ej. "Mi correo"). La aplicación comienza a generar tokens o PIN
   4. Luego, el sitio Web nos pide que ingresemos los tokens para validar que todo funciona correctamente.
   5. Si todo es correcto, el sitio nos brinda unos tokens de backup para resguardar. Debemos tomar nota de estos números y guardarlos en un lugar seguro.

   Uso habitual:

   1. Iniciamos sesión al sitio (p. ej. nuestro correo). Nos pedirá nombre de usuario y contraseña. Ingresamos eso datos y si todo es correcto, el sitio nos permite continuar.
   2. Luego, el sitio nos pide el token OTP (el segundo factor).
   3. Abrimos la aplicación en nuestro celular, y buscamos el nombre del sitio que registramos (p. ej. "Mi correo"). Copiamos el número que figura (token) al sitio antes de que pase el tiempo.

4. ¿Y si pierdo la aplicación?
...
5. Otros usos:
   ...
   1. Algunos servicios registran el número de celular del dueño o dueña de una cuenta para enviar el token por SMS o WhatsApp. Esto evita la instalación de otra aplicación.

   2. Uso:

      1. Cuando se realiza una operación de riesgo, y el servicio necesita validar la autenticación envía un token por un medio alternativo al del mismo servicio. Puede ser SMS, WhatsApp, Correo Electrónico u otro.

         Este token se espera que llegue a un celular o un dispositivo en posesión del usuario a validar.

      2. El usuario recibe el token y lo copia al sitio o aplicación del servicio.

   3. Ejemplos:

      1. WhatsApp utiliza este método al momento de cambiar el celular: determina si el celular viejo aún está en posesión del dueño enviando un token a ese celular para que sea ingresado en el nuevo.

         \warning{} Muchas ciberdelincuentes utilizan este método para tomar control del WhatsApp: engañan a las víctimas para que les envíen los tokens OTP que llega por SMS a sus celulares.

      2. GMail utiliza este método para validar que el usuario que está iniciando sesión es quién dice ser.

      3. Para validar recetas de obras sociales, usualmente piden el "token": es un OTP como el explicado primeramente.
...
* Columna 49: Contraseñas y autenticación
:PROPERTIES:
:ID:       d2f13ffd-5e0d-4519-be2d-fa3d4f172755
:PUBDATE:  2025-11-13 jue 17:34
:END:

{{{tag(columna-49)}}}

1. Repaso
   1. *Identificación*: es simplemente la afirmación de quién es alguien o qué es algo en particular.
   2. *Autenticación*: métodos que establece que esta afirmación es verdadera. Pero no indica qué tiene permitido hacer.
   3. *Factores de autenticación*: algo que sabés, algo que eres, algo que tenés, algo que hacés, dónde estás.
2. Algo que yo sé: contraseñas...
...
3. Caducidad de las contraseñas:
   ...
   - El tiempo depende de la robusteza/complejidad de la contraseña: cuanto más robusta/compleja, más se puede extender en el tiempo.
     ...
     ... pero ¿por qué? \to{} Por los ataques que se pueden hacer para adivinar contraseñas.
4. Ataques a contraseñas:
   - Ataques:
     1. Fuerza bruta: se prueba de a una contraseña cambiando un caracter a la vez.
     2. Diccionarios: se utiliza un diccionario de contraseñas y se prueba con cada frase del diccionario.
        1. Los diccionarios pueden contener palabras del idioma, contraseñas típicas, mezclas de palabras habituales, nombres y apellidos, DNI y fechas conocidas, frases habituales, etc.
...
5. Contraseñas robustas/complejas:
...
6. Higiene de contraseña: estrategias para crear contraseñas fáciles de recordar:

   #+caption: Historieta de XKCD 936 mostrando la robusteza de una contraseña.
   https://imgs.xkcd.com/comics/password_strength.png

   [[https://xkcd.com/936/][XKCD Número 936]] ([[https://www.explainxkcd.com/wiki/index.php/936:_Password_Strength][XKCD Número 936 explicado]])
   1. Generada con una estrategia/algoritmo y frases:
      1. Podemos pensar en una frase que nos gusta: "Mete toma 5 litros de mates"
      2. Podemos tomar las iniciales de cada palabra: "mt5ldm".
      ...
      3. La estrategia de creación es nuestra y la podemos repetir. Pero la frase es importante y no debemos darla a conocer.
         
      Un ejemplo similar son las tarjetas de contraseñas (ver [[https://f-droid.org/es/packages/com.passcard/][App para Android]]):

      #+caption: Una tarjeta de contraseñas de ejemplo.
      https://raw.githubusercontent.com/cryptofuture/PassCard/master/passcard.png

   2. Completamente generada aleatoriamente:

      El problema es que debemos usar un baúl para guardarla: ¡no nos vamos a acordar nunca!

   3. Generado por hashes:

      ¡Otro día les cuento!
   
7. Baúles o almacenes de contraseñas.

   - Firefox y Chrome poseen su vaúles y pueden generar contraseñas aleatorias robustas.
   - [[https://www.keepassdx.com/][KeePassDX]] ([[https://f-droid.org/es/packages/com.kunzisoft.keepass.libre/][App KeePassDX para Android]], también está en Google Play).
   - ¿Un papel o libreta? mmm... si se puede evitar mejor...
   
8. OpenID o el login con Google (y otros proveedores).

* Columna 48: Realidad Amentada, Realidad Virtual y Metaverso
:PROPERTIES:
:ID:       1f5fc196-f27e-4f86-a26f-b5a975dd792d
:PUBDATE:  2025-11-13 jue 17:34
:END:
...
1. Realidad Aumentada
   ...
   1. Los lentes, la cámara o un video que muestra algo de la realidad
   2. Se amplía esa imágen de la realidad con información digital: texto, imágenes, videos, modelos 3D.
   3. La ideas es ampliar los sentidos y la interacción con el mundo real.
      1. P. ej.: aumentando la percepción sonora de una persona con deficiencia auditiva, mostrando pistas visuales en un visor. 
...
1. Realidad Virtual
   ...
   1. Se utilizan cascos de realidad virtual, guantes, sensores de posición (giroscopio, orientación, etc.).
   2. Dan sensación de inmerción.
   3. Pueden ser interactivos:
      1. los guantes tienen sensores que detectan nuestras manos y cómo se mueven
      2. si giramos nuestra cabeza o nuestro cuerpo, también gira en el mundo virtual

   4. Se puede pensar como un continuo que va desde el entorno real, realidad aumentada y entorno virtual.

2. Metaverso

   Es un entorno o mundo virtual.

   1. Pueden simular entornos reales o no:
      - Pueden simular edificios y entornos reales.
      - Pueden crearse edificios y entornos ficticios.
   2. Pueden tener o no conexión a la realidad:
   ...
   3. Pueden tener las mismas limitaciones que la realidad o no:
...
4. ¿Para qué se pueden usar? Ejemplos:
   ...
   2. Entretenimiento: Pokémon Go
   3. Deportes: fútbol se utiliza en televisión para marcar el orsay
...
1. Definición: básicamente proviene de /fishing/ que significa "pescar" en inglés.
   ...
   3. Técnicas para engañar a una víctima para ganar su confianza con el fin de manipularla y hacer que realice acciones.
...
#+attr_html: :width 25% :alt Cotización de $LIBRA
[[file:dexscreen-inicio-captura-priceusd.png]]
#+attr_html: :width 25% :alt Marcet cap de $LIBRA 
[[file:dexscreen-inicio-captura-mcapusd.png]]
...
#+attr_html: :alt Imagen 1 generada de Trump  :align center :style display: inline-block :width 100%
[[file:data/b3/59d6e2-72f5-421e-82cb-d99084686ba6/trump_arrested2_by_eliot_higgins.jpg]]

#+caption: Imágen generada por IA de Trump siendo arrestado, evento que no sucedió en la realidad.
#+attr_html: :alt  Imágen 2 generada de Trump  :align center :style display: inline-block :width 100%
...
#+attr_html: :alt Imágen generada de una persona inexistente :align center :style display: inline-block :width 50%
...
#+attr_html: :alt Imágen 1 generada por midjourney :align center :style display: inline-block :width 100%
...
#+attr_html: :alt  Imágen 2 generada por midjourney :align center :style display: inline-block :width 100%
...
#+attr_html: :alt Cables martítimos de fibra óptica :align center :width 100%
...
- The internet's undersea world. The Guardian.
  ...
  #+attr_html: :alt Thumbnail cables martítimos de fibra óptica :align center :width 25% :style display: inline-block
...
- Mapa de Cobertura de la REFEFO.
  ...
  #+attr_html: :alt Mapa REFEFO :align center :style display: inline-block :width 25%
...
#+attr_html: :alt Granja minera de computadoras :align center :width 100%
...
#+attr_html: :alt Imágen de burbujas chocando con mucho zoom. Su superficie tiene diferentes colores. :align center
...
#+attr_html: :alt Estatua representando Alan Turin. Atrás se observa su fotografía. :width 100%
...
#+attr_html: :alt Una pintura en acuarela retratando a Ada Lovelace con un vestido violáceo. :width 100%
