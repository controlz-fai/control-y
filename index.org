...
1. ¿Qué es una red social?
   1. Medio social: Web 2.0 o usuarios son productores y consumidores.
   2. Establecer contacto entre personas.
...
3. El Fediverso (federación + universo)
   ...
   4. ¿Y la moderación y la seguridad del usuario?
      ...
      Sin embargo, el administrador suele ser muy activo y entra en contacto frecuentemente con muchos usuarios de la red social. Esto es así porque crea el servidor por gusto y por el deseo de comunicarse. Por lo que siempre responden.
   ...
   5. ¿Y la privacidad?
      ...
      1. Depende del software/red social. Hay redes que pueden restringir una publicación a ciertos contactos, grupos o al público.
      2. No suelen solicitar infomación personal para crear una cuenta: podemos crear una cuenta con un pseudónimo (mientras cumplamos los términos de uso del servidor).
      3. Es posible crear un servidor personal, aunque requiere de conocimientos técnicos. Sino, se debe confiar en el administrador del servidor.
      4. Los administradores frecuentemente recomiendan no publicar información sensible.
      5. Debemos considerar que si buscamos integrarnos a una red social, a cierto punto tendremos que revelar información propia. Lo importante es entender qué podemos publicar y qué no: qué información es sensible y no debemos publicar nunca.
      6. En la mayor parte del fediverso sigue las ideas del software libre, el respeto al usuario: la autoría de los contenidos se respeta (no es del administrador/"dueño", sino de quien publica).
   ...
   6. ¿Y la disponibilidad? ¿puede ser censurado o caerse el servicio?
      ...
      2. siemper podés crearte varias cuentas en distintos servidores.
   
4. ¿Cómo es la experiencia de usarla?
   1. Se nos puede complicar inicialmente con los servidores/comunidades.
      Hasta que comprendemos que todos los servidores son parte de la misma red social.
