...
#+macro: tag (eval (if (equal org-export-current-backend 'rss) "" "#+html: <a id=\"$1\"></a>"))
...
#+html: <a href="http://validator.w3.org/feed/check.cgi?url="><img src="valid-rss-rogers.png" alt="[Valid RSS]" title="Validate my RSS feed" /></a>
...
- "DeepSeek: cómo los "héroes de la IA" de China superaron las restricciones de EE.UU. y desafiaron a Silicon Valley" por Fan Wang y João da Silva. BBC News. 1 de febrero del 2025.
  ...
  https://www.bbc.com/mundo/articles/cqx93d7e1weo
